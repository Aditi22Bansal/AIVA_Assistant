...
const WriteArticle = () => {
  ...
  const articleLength= [
    {length:1000, text: 'Short (500-800 words)'},
    {length:1800, text: 'Medium (800-1200 words)'},
    {length:2400, text: 'Long (1200+ words)'},
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border vorder-graya-200 min-h-96 max-h-[600px]'>
        <div className='flex items-center gap-3'>
