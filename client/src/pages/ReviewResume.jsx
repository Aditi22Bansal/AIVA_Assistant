    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <textarea
          ...
          placeholder="Paste the job description here to get a targeted resume review..."
          className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300 text-gray-600 resize-none'
          rows={6}
        />
        <p className='text-xs text-gray-500 font-light mt-1'>Leave empty for a general resume review.</p>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border vorder-graya-200 min-h-96 mx-h-[600px]'>
        <div className='flex items-center gap-3'>
